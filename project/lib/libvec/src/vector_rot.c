...
/*   Updated: 2023/07/29 21:42:45 by anvannin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*!
	...
	@note	The rotation of a vector around the X axis is found by the following
			formula:
			- x' = x * 1
...
/*!
	...
	@param	angle	The angle of rotation.
	@return	The rotated vector.
	@note	The rotation of a vector around the Y axis is found by the following
			formula:
...
/*!
	...
	@param	angle	The angle of rotation.
	@return	The rotated vector.
	@note	The rotation of a vector around the Z axis is found by the following
			formula:
